...
![Pantalla de Configuración](screenshots/config.png)
...
![Carpeta Cerrada](screenshots/reveal_closed.png)
...
![Carpeta Abierta](screenshots/reveal_open.png)
...
![Tablero de Investigación](screenshots/board.png)
...
1.  Abre la web en tu móvil (Chrome en Android o Safari en iOS).
2.  Abre el menú del navegador.
3.  Selecciona "Añadir a pantalla de inicio".
4.  ¡Ahora tendrás el icono de la app en tu escritorio y funcionará a pantalla completa!
